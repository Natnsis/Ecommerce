    ...
    <div className="w-screen h-screen flex justify-center items-center bg-gradient-to-bl from-blue-300 to-gray-100">
      <div className="w-80 bg-white h-92 rounded-2xl px-5 py-5">
        ...
        <div>
            ...
            <p className="text-red-500 text-center">this is an error message</p>
            <input type="password" className="w-70 border px-5 py-1 rounded text-center" placeholder="Enter Password" />
            <p className="text-red-500 text-center">this is an error message</p>
        </div>
        <div className="w-full flex justify-center my-3">
            <button className="bg-blue-300 rounded px-3 py-1 hover:bg-white hover:border">submit</button>
        </div>
        <div>
            <p className="text-center">You dont have an account? <Link to="/register">
            <span className="text-blue-300 hover:text-red-300">Register Here</span></Link></p>
        </div>
      </div>
    </div>
  )
